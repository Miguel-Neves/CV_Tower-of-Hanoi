...
function recSubdivisionMidPoint( v1, v2, v3, coordsArray, recursionDepth ) {
	...
	if( recursionDepth == 0 ) {
        ...
        // 4 recursive calls
        recSubdivisionMidPoint( v1, mid12, mid31, coordsArray, recursionDepth - 1 );
        recSubdivisionMidPoint( v2, mid23, mid12, coordsArray, recursionDepth - 1 );
        recSubdivisionMidPoint( v3, mid31, mid23, coordsArray, recursionDepth - 1 );
        recSubdivisionMidPoint( mid12, mid23, mid31, coordsArray, recursionDepth - 1 );
	}
}
...
function recSubdivisionCentroid( v1, v2, v3, coordsArray, recursionDepth ) {
	...
	if( recursionDepth == 0 ) {
        ...
        // 3 recursive calls
        recSubdivisionCentroid( v1, v2, centroid, coordsArray, recursionDepth - 1 );
        recSubdivisionCentroid( v2, v3, centroid, coordsArray, recursionDepth - 1 );
        recSubdivisionCentroid( v3, v1, centroid, coordsArray, recursionDepth - 1 );
    }
}

//----------------------------------------------------------------------------

function centroidRefinement( coordsArray, recursionDepth ) {
...
function moveToSphericalSurface( coordsArray ) {
	// Each vertex is moved to the spherical surface of radius 1 and centered at (0,0,0)
    // This is done by handling each vertex as if it were a position vector, and normalizing
